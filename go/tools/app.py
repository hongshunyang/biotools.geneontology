...
def main(argv):
	...
	for opt, arg in opts:
		if opt == '-h':
			...
			print 'exmaple: -i ./../data/1104/BP/GO-BP-CDS.csv -s settings.conf -c BP-GOID.txt -t goid '
			print 'exmaple: -i ./../data/1104/BP/GO-BP-CDS.csv -g ./../result/BP_desendant_ancestor.csv -c BP-GOID.txt -t goid '
			sys.exit()
		elif opt in ("-i","--input"):
